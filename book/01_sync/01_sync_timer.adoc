...
TIP: This section will teach you what execution_contexts and io-objects are, and how typical 
...
<2> The timer io-object, initialized with a hard-coded delay.
...
((io-object))::
    An io-object is a type that performs operations within a given execution-context.

((timer))::
    A timer is an io-object that be awaited and cancelled.
